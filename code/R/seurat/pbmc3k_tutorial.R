...
# Raw data: https://cf.10xgenomics.com/samples/cell/pbmc3k/pbmc3k_filtered_gene_bc_matrices.tar.gz
...
pbmc.data <- Read10X(data.dir = paste0(Sys.getenv("HOME"), "/../data/10XGenomics/data/pbmc3k/filtered_gene_bc_matrices/hg19/"))
